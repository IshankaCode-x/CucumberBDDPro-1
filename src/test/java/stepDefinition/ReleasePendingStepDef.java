...
@When("I Scroll to Yard Management  CORP")
public void i_scroll_to_yard_management_corp() throws Throwable{
	Thread.sleep(3000);
	ReleasePendingSub var1=new ReleasePendingSub(driver);
...
@When("I upload file CORP")
public void i_upload_file_corp() throws Throwable{
	Thread.sleep(3000);
	String filePath ="C:\\Users\\IshankaPu\\Pictures\\Screenshots\\ss.pdf";
	 ReleasePendingSub var1=new ReleasePendingSub(driver);
	var1.uploadfile().sendKeys(filePath);
	Thread.sleep(3000);
}
